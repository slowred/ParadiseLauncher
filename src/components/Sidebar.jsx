          ...
          <div className="logo-icon">
            ...
            >
              <path d="M189.895,77.707c6.935-17.31,20.551-31.902,39.134-39.606c18.571-7.7,38.529-7.027,55.667,0.303
                l3.88,23.346l-32.324,42.024l-61.758-6.942" fill="#00E5FF" />
              <path d="M308.109,430.278l-84.374-5.25c21.97-51.163,31.322-106.248,28.021-160.759l-17.246-50.541
                ...
                C339.503,280.51,333.679,357.971,308.109,430.278z" fill="#00A3B9" />
              <g>
                <path d="M256.253,103.772c-21.467-0.897-42.528,5.298-59.989,17.234
                  ...
                  C238.182,89.816,247.941,96.141,256.253,103.772z" fill="#00E5FF" />
                <path d="M446.409,145.702c-4.569,11.027-10.895,20.786-18.525,29.097
                  ...
                  h0.012C452.078,64.103,462.399,107.061,446.409,145.702z" fill="#00E5FF" />
              </g>
              <path d="M256.253,103.772c-21.467-0.897-42.528,5.298-59.989,17.234c0,0-54.452-33.534-98.271,17.784
                c20.881-50.445,78.705-74.424,129.151-53.543C238.182,89.816,247.941,96.141,256.253,103.772z" fill="#008B9E" />
              <path d="M325.558,205.859c-34.419,34.431-76.888,12.892-76.888,12.892l-14.16-5.023l-11.314-33.176
                l15.44-69.784l37.11-32.338l28.978,53.172C313.922,155.832,320.87,180.684,325.558,205.859z" fill="#008B9E" />
              <path d="M423.698,36.714c-79.578-11.397-104.526,34.97-104.861,35.615h-0.012
                ...
                C404.67,21.431,415.027,28.343,423.698,36.714z" fill="#008B9E" />
              <g>
                <path d="M275.412,268.502c-40.818-1.316-75.62-32.326-80.475-74.113c-0.777-6.649-0.753-13.203,0-19.566
                  ...
                  C245.741,219.146,257.676,246.365,275.412,268.502z" fill="#00E5FF" />
                <path d="M359.26,233.747c-3.121-28.2-13.945-55.887-32.877-79.758c-3.086-3.899-6.327-7.606-9.699-11.134
                  ...
                  C389.829,157.387,387.185,203.933,359.26,233.747z" fill="#00E5FF" />
              </g>
              <g>
                <path d="M256.253,103.772c-8.671,18.238-13.897,38.294-14.902,59.271
                  c-28.093-12.725-46.415,11.78-46.415,11.78C198.895,141.158,223.089,112.742,256.253,103.772z" fill="#008B9E" />
                <path d="M316.684,142.855c-17.281-18.047-38.067-31.154-60.431-39.084
                  c26.132-15.033,57.98-14.591,83.382-0.06C307.798,112.204,316.684,142.855,316.684,142.855z" fill="#008B9E" />
              </g>
              <path d="M440.482,503.03c-105.597-105.597-276.805-105.597-382.403,0" fill="#00A3B9" strokeWidth="2" stroke="#008B9E" strokeLinecap="round" />
            </svg>
          </div>
        )}
      </div>
